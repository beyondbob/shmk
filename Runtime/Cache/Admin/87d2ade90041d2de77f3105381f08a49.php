...
<body>
 ...
 <?php if(isset($cate_rows)): ?></div><?php endif; ?> 
    ...
    <div class="cf">
        <a class="btn" href="<?php echo U('addTypeOne',array('pid'=>I('get.pid')));?>">新 增</a>
        ...
        <!-- <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/shmk/index.php?s=/Admin/GoodsCategory/goodsTypeOne.html"><i class="btn-search"></i></a>
            </div>
        </div> -->
    </div>
        ...
        <form class="ids">
            <table>
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <a title="编辑" href="<?php echo U('addTypeOne?goodstype_id='.$menu['goodstype_id']);?>">编辑</a>
