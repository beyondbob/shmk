...
<body>
    ...
    <div class="header">
        ...
        <ul class="main-nav">
            ...
            <li class="current"><a href="/shmk/index.php?s=/Admin/AuthManager/index.html">系统</a></li><li class=""><a href="/shmk/index.php?s=/Admin/Menu/index.html">用户</a></li>
   ...
   <div class="sidebar">
        <!-- 子导航 -->
            ...
            <div id="subnav" class="subnav">
                                <!-- 子导航 -->
                    <h3><i class="icon icon-unfold"></i>首页管理</h3>                        <ul class="side-sub-menu">
                            <li>
                                    <a class="item" href="./ads.html">广告位管理</a>
                                </li>                       </ul>                    <!-- /子导航 --><!-- 子导航 -->
    ...
    <tbody>
		<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
           <!--  <td><input class="ids" type="checkbox" name="id[]" value="<?php echo ($vo["student_id"]); ?>" /></td> -->
            ...
            <td><img style="width: 120px;height: 60px;" src="/shmk<?php echo ($vo["path"]); ?>"></td>
            <td><?php echo ($vo["goods_name"]); ?></td>
            <td><?php echo ($vo["time"]); ?></td>
            <td><?php echo ($vo["status_text"]); ?></td>
			<td>
				<?php if($vo["status"] == 1): ?><a class="ajax-get confirm" href="<?php echo U('Parameter/onoff?status=0&id='.$vo['id']);?>">禁用 </a>|
				<?php else: ?>
					<a class="ajax-get" href="<?php echo U('Parameter/onoff?status=1&id='.$vo['id']);?>">启用 </a>|<?php endif; ?>
				<a href="<?php echo U('Parameter/editAdImg?id='.$vo['id']);?>">编辑</a>
			</td>
...
<script type="text/javascript" charset="utf-8">
    //导航高亮
    highlight_subnav('/code/index.php?s=/Admin/AuthManager/index.html');
</script>
    ...
    //导航高亮
    highlight_subnav('<?php echo U('Parameter/shop');?>');
	</script>
