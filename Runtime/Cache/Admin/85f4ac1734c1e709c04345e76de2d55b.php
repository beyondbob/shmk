...
<body>
 ...
 <?php if(isset($cate_rows)): ?></div><?php endif; ?> 
	...
	<div style="margin-bottom:20px;margin-top">
		<a class="btn" href="<?php echo U('Parameter/addAdImg');?>">新 增</a>
		<a class="btn" href="<?php echo U('Parameter/delAdImg');?>">删 除</a>
		 <div class="search-form fr cf">
			<div class="sleft">
                <input type="text" name="selvalue" class="search-input" value="<?php echo I('selvalue');?>" placeholder="输入商品名称">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('shop');?>"><i class="btn-search"></i></a>
			</div>
          </div>
    </div>
