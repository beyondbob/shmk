 ...
 <?php if(isset($cate_rows)): ?></div><?php endif; ?> 
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            <td><input class="ids" type="checkbox" name="shmk_id" value="<?php echo ($vo["shmk_id"]); ?>" /></td>
			<td><?php echo ($vo["shmk_id"]); ?></td>
		    <td><img width="35px" src='/shmk<?php echo ($vo["avatar"]); ?>'/> <?php echo ($vo["nick"]); ?></td>
			...
			<td>
				...
				<?php if(($vo["status"]) == "1"): ?><a href="<?php echo U('Member/changeStatus?method=forbid&shmk_id='.$vo['shmk_id']);?>" class="confirm ajax-get">禁用</a>
				<?php else: ?>
					<a href="<?php echo U('Member/changeStatus?method=resume&shmk_id='.$vo['shmk_id']);?>" class="confirm ajax-get">启用</a><?php endif; ?>
