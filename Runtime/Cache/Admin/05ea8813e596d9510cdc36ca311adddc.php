 ...
 <?php if(isset($cate_rows)): ?></div><?php endif; ?> 
   ...
   <div class="main-title">
    ...
    <div class="tab-content">
        <!-- 表单 -->
        <form action="<?php echo U('editAdImg');?>" class="form-horizontal" method="post" >
            <table class="item-details">
                <tbody>
                    <tr class="form-item">
                        <td class="row-left">商品</td>
                        <td class="row-right">
                            <div class="controls">
                                <select name="good_id" style="width: 300px;">
                                    <option value="<?php echo ($info["good_id"]); ?>"><?php echo ($info["goods_name"]); ?></option>
                                </select>
                            </div>
