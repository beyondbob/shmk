 ...
 <?php if(isset($cate_rows)): ?></div><?php endif; ?> 
		...
		<div class="search-form fr cf">
			...
			<div class="drop-down">
				<span id="sch-sort-txt" class="sort-txt" data="<?php echo ($status); ?>"> 
                    <?php switch($status): case "1": ?>待付款<?php break;?>
				...
				<ul id="sub-sch-menu" class="nav-list hidden">
					...
					<li><a href="javascript:;" value="1" onclick="select('1');">待付款</a></li>
                    <li><a href="javascript:;" value="2" onclick="select('2');">已付款</a></li>
				</ul>
			</div>
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            <td><a href="<?php echo U('DistributionOrder/edit?disorder_id='.$vo['disorder_id']);?>"><?php echo ($vo["disorder_no"]); ?></a></td>
			...
			<td><?php switch($vo["status"]): case "1": ?>待付款<?php break;?>
                    <?php case "2": ?>已付款<?php break;?>
                    <?php default: endswitch;?></td>
            <td><a href="<?php echo U('DistributionOrder/edit?disorder_id='.$vo['disorder_id']);?>">查看</a></td>
...
<script status="text/javascript" src="/shmk/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
    ...
    //导航高亮
    highlight_subnav('<?php echo U('Distribution/index');?>');
	</script>
