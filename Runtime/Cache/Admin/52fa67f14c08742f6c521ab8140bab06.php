 ...
 <?php if(isset($cate_rows)): ?></div><?php endif; ?> 
	...
	<div class="cf">
		...
		<div class="search-form fr cf">
			<div class="sleft">
    			<div class="drop-down">
    				<span id="sch-sort-txt" class="sort-txt" data="<?php echo ($status); ?>"> <?php if($status == ''): ?>全部<?php endif; ?> <?php if($status == '0'): ?>已禁用<?php endif; ?>
    					<?php if($status == '1'): ?>已开启<?php endif; ?>
    				</span> <i class="arrow arrow-down"></i>
    				<ul id="sub-sch-menu" class="nav-list hidden">
    					<li><a href="javascript:;" value="" onclick="select('');">全部</a></li>
    					<li><a href="javascript:;" value="1" onclick="select('1');">已开启</a></li>
    					<li><a href="javascript:;" value="0" onclick="select('0');">已禁用</a></li>
    				</ul>
    			</div>
				<input type="text" name="selvalue" class="search-input" value="<?php echo I('selvalue');?>" placeholder="输入店铺名称">
            ...
            <div class="btn-group-click adv-sch-pannel fl">
                ...
                <div class="dropdown cf">
                    <div class="row">
                        <label>商品名称：</label>
                        <input type="text" name="good-name" class="text input-2x" value="" placeholder="输入商品名称">
                    </div>
                </div>
            </div>
		</div>
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			<td><input class="ids" type="checkbox" name="shop_id[]" value="<?php echo ($vo["shop_id"]); ?>" /></td>
            <td><?php echo ($vo["shop_name"]); ?></td>
            <td><?php echo ($vo["name"]); ?></td>
            <td><?php echo ($vo["nick"]); ?></td>
            <td><img width="35px" src='<?php echo ($vo["avatar"]); ?>'/></td>
            ...
            <td><?php if($vo["status"] == '1'): ?><a href="<?php echo U('Shop/changeStatus?method=forbid&shop_id='.$vo['shop_id']);?>" class="ajax-get">禁用</a>
				<?php else: ?>
				<a href="<?php echo U('Shop/changeStatus?method=resume&shop_id='.$vo['shop_id']);?>" class="ajax-get">启用</a><?php endif; ?>
	            |<a href="<?php echo U('Shop/edit?shop_id='.$vo['shop_id']);?>">详情</a>
	        </td>
