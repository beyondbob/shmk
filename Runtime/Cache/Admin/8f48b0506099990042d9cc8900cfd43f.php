 ...
 <?php if(isset($cate_rows)): ?></div><?php endif; ?> 
    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
            <div class="drop-down">
                <span id="sch-sort-txt" class="sort-txt" data="<?php echo ($status); ?>"> <?php if($status == ''): ?>全部<?php endif; ?> <?php if($status == '1'): ?>已上架<?php endif; ?>
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('shopgoods');?>"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
    <!-- 数据列表 -->
    ...
    //导航高亮
    highlight_subnav('<?php echo U('Shop/shopgoods');?>');
    </script>
