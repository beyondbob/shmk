 ...
 <?php if(isset($cate_rows)): ?></div><?php endif; ?> 
    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('purchaseIndex');?>"><i class="btn-search"></i></a>
            </div>
    ...
    <tbody>
        <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            <td><a href="<?php echo U('Supplement/purchaseEdit?purorder_extra_id='.$vo['purorder_extra_id']);?>"><?php echo ($vo["purorder_no"]); ?></a></td>
            ...
            <td><a href="<?php echo U('Supplement/purchaseEdit?purorder_extra_id='.$vo['purorder_extra_id']);?>">查看</a></td>
...
<script status="text/javascript" src="/shmk/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
    ...
    //导航高亮
    highlight_subnav('<?php echo U('Supplement/purchaseIndex');?>');
    </script>
