...
<body>
 ...
 <?php if(isset($cate_rows)): ?></div><?php endif; ?> 
    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                ...
                <input type="text" name="selvalue" class="search-input" value="<?php echo I('selvalue');?>" placeholder="输入姓名">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('checkCertificate');?>"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
    <!-- 数据列表 -->
    <div class="data-table table-striped">
        <table class="">
            ...
            <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><img width="40px" src='<?php echo ($vo["avatar"]); ?>'/> </td>
                        <td><?php echo ($vo["nick"]); ?></td>
                        <td><img width="40px" src='<?php echo ($vo["path"]); ?>'/> </td>
                        <td>
                            <a target="_blank" href="<?php echo ($vo["path"]); ?>">查看证书</a>
                        </td>
    ...
    <script type="text/javascript">
        ...
        //导航高亮
        highlight_subnav('<?php echo U("checkCertificate");?>');
    </script>
