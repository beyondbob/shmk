 ...
 <?php if(isset($cate_rows)): ?></div><?php endif; ?> 
    ...
    <div class="cf">
        <form action="<?php echo U();?>" method="post" class="form-horizontal">
            <?php if($isDivided == 0): ?><button class="btn submit ajax-post confirm" id="submit" type="submit" target-form="form-horizontal">分 红</button>
            <?php else: ?>
                <button class="btn submit ajax-post confirm" id="submit" type="submit" target-form="form-horizontal" disabled="disabled" style="cursor:not-allowed">分 红</button><?php endif; ?>
        </form>
    </div>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="width: 20%">分红总积分</th>
                    </tr>
                </thead>
                <tbody>
                <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td style="width: 15%"><?php echo ($vo["year"]); ?></td>
                        <td style="width: 20%"><?php echo ($vo["bonus"]); ?></td>
    ...
    <script type="text/javascript">
    highlight_subnav('<?php echo U('Integral/yearDivideList');?>');
    </script>
