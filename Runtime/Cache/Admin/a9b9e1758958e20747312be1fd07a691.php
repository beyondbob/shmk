...
<body>
 ...
 <?php if(isset($cate_rows)): ?></div><?php endif; ?> 
    ...
    <div class="cf">
        <div class="fl">
            <input type="button" name="excel" value="导出为Excel" style="margin-right:5px;padding:6px 16px;font-size:14px;line-height:18px;text-align:center;vertical-align:middle;border:0 none;color:#edffd1;background-color:#4bbd00;cursor:pointer" onclick="location.href='/shmk/admin.php/Log/expdrivingrecord'">
        </div>
        <!-- 高级搜索 -->
        <div class="search-form fr cf">
            ...
            <div class="drop-down" id="status-drop-down">
                <span id="sch-sort-txt" class="sort-txt" style="width:auto" data="<?php echo ($type); ?>"> 
                    <?php switch($type): case "0": ?>零钱<?php break;?>
						<?php case "1": ?>银行卡<?php break;?>
            ...
            <div class="drop-down" id="type-drop-down">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('drivingrecord');?>"><i class="btn-search"></i></a>
            </div>
    ...
    <tbody>
        <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td style="text-align:center"><?php echo ($vo["in_station"]); ?></td>
            <td style="text-align:center"><?php echo ($vo["out_station"]); ?></td>
            <td style="text-align:center"><?php echo ($vo["in_station_time"]); ?></td>
            <td style="text-align:center"><?php echo ($vo["out_station_time"]); ?></td>
			<td style="text-align:center;"><?php switch($vo["paytype"]): case "0": ?>零钱<?php break; case "1": ?>银行卡<?php break; endswitch;?></td>
            <td style="text-align:center;"><?php echo ($vo["check"]); ?></td>
...
<script status="text/javascript" src="/shmk/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
    ...
    //导航高亮
    highlight_subnav('<?php echo U('Log/drivingrecord');?>');
    </script>
