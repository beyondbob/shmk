...
function exportExcel($expTitle,$expCellName,$expTableData){
        ...
        $objPHPExcel->getActiveSheet(0)->getStyle('A1:'.$cellName[$cellNum-1].'1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);//居中
    ...
    //string_format
    //echo string_format("你好,{0},{1},{2}", '张三','李四','王五');
    //输出:你好,张三,李四,王五
